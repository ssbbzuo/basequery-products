...
//		HashMap<String, String> tokenMap = grantToken(grantCode());
	...
	public static AdminUserLoginAccount getAdminUserInfo(String adminUserId, String accessToken) throws Exception {
		...
		// System.out.println("getAdminUserInfo:returnMessage: : " +
		// returnMessage);
	...
	public static Boolean saveAdminUserInfo(String currentUserId, String accessToken, AdminUserInfo userInfo)
			throws Exception {
		...
		paramMap.put("userCode", userInfo.getUnitCode());
		paramMap.put("mobile", userInfo.getMobile());
		paramMap.put("email", userInfo.getEmail());
		paramMap.put("ee", userInfo.getEe());
		paramMap.put("sex", userInfo.getSex());
		paramMap.put("idCard", userInfo.getIdCard());
		paramMap.put("birthday", userInfo.getBirthday());
		paramMap.put("companyTele", userInfo.getCompanyTele());
		paramMap.put("unitCode", userInfo.getUnitCode());
		paramMap.put("address", userInfo.getAddress());

		HttpClientUtil httpUtil = HttpClientUtil.getInstance("UTF-8");
		String returnMessage = httpUtil.getResponseBodyAsString(Constant.saveAdminUserUrl, paramMap);
	...
	public static Boolean registeAdminUserLoginAccount(String currentUserId, String accessToken, AdminUserLoginAccount accountInfo)
			throws Exception {
		HashMap<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("appId", Constant.appId);
		paramMap.put("appSecretKey", AuthenUtils.encrypt(Constant.appSecretKey + "##" + System.currentTimeMillis()));
		...
		paramMap.put("userInfo.atid", accountInfo.getUserInfo().getAtid());
		paramMap.put("userCode", accountInfo.getLoginAccount());
		paramMap.put("mobile", accountInfo.getLoginAccount());

		HttpClientUtil httpUtil = HttpClientUtil.getInstance("UTF-8");
		String returnMessage = httpUtil.getResponseBodyAsString(Constant.registeAdminUserLoginAccount, paramMap);
	...
	public static Boolean initAdminUserLoginPassword(String currentUserId,String adminUserId,String password, String accessToken)
			throws Exception {
		HashMap<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("appId", Constant.appId);
		paramMap.put("appSecretKey", AuthenUtils.encrypt(Constant.appSecretKey + "##" + System.currentTimeMillis()));
		...
		paramMap.put("adminUser.atid", adminUserId);
		paramMap.put("password", password);

		HttpClientUtil httpUtil = HttpClientUtil.getInstance("UTF-8");
		String returnMessage = httpUtil.getResponseBodyAsString(Constant.initAdminUserLoginPassword, paramMap);
	...
	public static Boolean changeAdminUserLoginPassword(String currentUserId,String adminUserId,String password, String accessToken)
			throws Exception {
		HashMap<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("appId", Constant.appId);
		paramMap.put("appSecretKey", AuthenUtils.encrypt(Constant.appSecretKey + "##" + System.currentTimeMillis()));
		...
		paramMap.put("newSecretKey", AuthenUtils.encrypt(Constant.appSecretKey + "##" + System.currentTimeMillis()));
	...
	public static String loginUserGrantCode(String account, String password)
	...
	public static HashMap<String, String> grantToken(String grantCode) throws IllegalArgumentException, Exception {
		...
		// System.out.println("accessToken : " + accessToken + ", refreshToken :
		// " + refreshToken + " user atid: "+userId);
