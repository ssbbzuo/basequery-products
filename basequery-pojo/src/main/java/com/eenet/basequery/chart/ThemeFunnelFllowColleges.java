...
public class ThemeFunnelFllowColleges extends BaseEntity{

	
	private static final long serialVersionUID = 5866891569541028742L;
	private String DIM_COLLEGES;//网院
	...
	public String getDIM_COLLEGES() {
		return DIM_COLLEGES;
	}
	public void setDIM_COLLEGES(String dIM_COLLEGES) {
		DIM_COLLEGES = dIM_COLLEGES;
	}
