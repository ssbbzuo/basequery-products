...
public class ThemeFunnelFllowLearnCenterUser extends BaseEntity{

	
	private static final long serialVersionUID = 5866891569541028742L;
	private String DIM_LEARNCENTER_USER;//班主任
	...
	public String getDIM_LEARNCENTER_USER() {
		return DIM_LEARNCENTER_USER;
	}
	public void setDIM_LEARNCENTER_USER(String dIM_LEARNCENTER_USER) {
		DIM_LEARNCENTER_USER = dIM_LEARNCENTER_USER;
	}
