...
public class ThemeFunnelCompanyProduceAccount extends BaseEntity{
	...
	public String getDIM_ADMIN_LOGIN_ACCOUNT() {
		return DIM_ADMIN_LOGIN_ACCOUNT;
	}
	public void setDIM_ADMIN_LOGIN_ACCOUNT(String dIM_ADMIN_LOGIN_ACCOUNT) {
		DIM_ADMIN_LOGIN_ACCOUNT = dIM_ADMIN_LOGIN_ACCOUNT;
	}
