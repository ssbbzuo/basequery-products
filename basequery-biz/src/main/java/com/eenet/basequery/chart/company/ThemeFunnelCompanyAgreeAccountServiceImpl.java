...
public class ThemeFunnelCompanyAgreeAccountServiceImpl extends SimpleBizImpl implements ThemeFunnelCompanyAgreeAccountService {
	...
	@Override
	public Class<ThemeFunnelCompanyAgreeAccount> getPojoCLS() {
		return ThemeFunnelCompanyAgreeAccount.class;
	}
