...
public class ThemeFunnelReadLearnCenterUserServiceImpl extends SimpleBizImpl implements ThemeFunnelReadLearnCenterUserService {
	...
	@Override
	public Class<ThemeFunnelReadLearnCenterUser> getPojoCLS() {
		return ThemeFunnelReadLearnCenterUser.class;
	}
