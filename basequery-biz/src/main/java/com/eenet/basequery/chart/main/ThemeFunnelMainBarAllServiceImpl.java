...
public class ThemeFunnelMainBarAllServiceImpl extends SimpleBizImpl implements ThemeFunnelMainBarAllService {
	...
	@Override
	public Class<ThemeFunnelMainBarAll> getPojoCLS() {
		return ThemeFunnelMainBarAll.class;
	}
