...
public class ThemeFunnelMainNumberServiceImpl extends SimpleBizImpl implements ThemeFunnelMainNumberService {
	...
	@Override
	public Class<ThemeFunnelMainNumber> getPojoCLS() {
		return ThemeFunnelMainNumber.class;
	}
