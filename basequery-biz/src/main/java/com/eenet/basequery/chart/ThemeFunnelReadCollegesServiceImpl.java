...
public class ThemeFunnelReadCollegesServiceImpl extends SimpleBizImpl implements ThemeFunnelReadCollegesService {
	...
	@Override
	public Class<ThemeFunnelReadColleges> getPojoCLS() {
		return ThemeFunnelReadColleges.class;
	}
