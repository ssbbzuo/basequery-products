...
public class ThemeFunnelMainBarYearServiceImpl extends SimpleBizImpl implements ThemeFunnelMainBarYearService {
	...
	@Override
	public Class<ThemeFunnelMainBarYear> getPojoCLS() {
		return ThemeFunnelMainBarYear.class;
	}
