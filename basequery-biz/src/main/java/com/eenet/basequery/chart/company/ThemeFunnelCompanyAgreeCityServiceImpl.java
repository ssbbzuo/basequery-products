...
public class ThemeFunnelCompanyAgreeCityServiceImpl extends SimpleBizImpl implements ThemeFunnelCompanyAgreeCityService {
	...
	@Override
	public Class<ThemeFunnelCompanyAgreeCity> getPojoCLS() {
		return ThemeFunnelCompanyAgreeCity.class;
	}
