...
public class ThemeFunnelFReadSalemanServiceImpl extends SimpleBizImpl implements ThemeFunnelFReadSalemanService {
	...
	@Override
	public Class<ThemeFunnelFReadSaleman> getPojoCLS() {
		return ThemeFunnelFReadSaleman.class;
	}
