...
public class ThemeFunnelCompanyAffirmPSServiceImpl extends SimpleBizImpl implements ThemeFunnelCompanyAffirmPSService {
	...
	@Override
	public Class<ThemeFunnelCompanyAffirmPS> getPojoCLS() {
		return ThemeFunnelCompanyAffirmPS.class;
	}
