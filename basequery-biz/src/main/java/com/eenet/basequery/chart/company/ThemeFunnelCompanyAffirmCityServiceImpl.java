...
public class ThemeFunnelCompanyAffirmCityServiceImpl extends SimpleBizImpl implements ThemeFunnelCompanyAffirmCityService {
	...
	@Override
	public Class<ThemeFunnelCompanyAffirmCity> getPojoCLS() {
		return ThemeFunnelCompanyAffirmCity.class;
	}
