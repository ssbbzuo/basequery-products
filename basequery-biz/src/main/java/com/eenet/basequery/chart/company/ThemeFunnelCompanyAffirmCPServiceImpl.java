...
public class ThemeFunnelCompanyAffirmCPServiceImpl extends SimpleBizImpl implements ThemeFunnelCompanyAffirmCPService {
	...
	@Override
	public Class<ThemeFunnelCompanyAffirmCP> getPojoCLS() {
		return ThemeFunnelCompanyAffirmCP.class;
	}
