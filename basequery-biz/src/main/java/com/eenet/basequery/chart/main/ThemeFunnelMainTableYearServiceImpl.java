...
public class ThemeFunnelMainTableYearServiceImpl extends SimpleBizImpl implements ThemeFunnelMainTableYearService {
	...
	@Override
	public Class<ThemeFunnelMainTableYear> getPojoCLS() {
		return ThemeFunnelMainTableYear.class;
	}
