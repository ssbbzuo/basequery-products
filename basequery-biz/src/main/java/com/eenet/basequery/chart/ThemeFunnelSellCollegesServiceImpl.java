...
public class ThemeFunnelSellCollegesServiceImpl extends SimpleBizImpl implements ThemeFunnelSellCollegesService {
	...
	@Override
	public Class<ThemeFunnelSellColleges> getPojoCLS() {
		return ThemeFunnelSellColleges.class;
	}
