...
public class ThemeFunnelCompanyProduceStructuresServiceImpl extends SimpleBizImpl implements ThemeFunnelCompanyProduceStructuresService {
	...
	@Override
	public Class<ThemeFunnelCompanyProduceStructures> getPojoCLS() {
		return ThemeFunnelCompanyProduceStructures.class;
	}
