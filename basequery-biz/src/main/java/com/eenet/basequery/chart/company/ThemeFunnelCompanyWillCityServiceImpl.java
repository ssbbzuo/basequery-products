...
public class ThemeFunnelCompanyWillCityServiceImpl extends SimpleBizImpl implements ThemeFunnelCompanyWillCityService {
	...
	@Override
	public Class<ThemeFunnelCompanyWillCity> getPojoCLS() {
		return ThemeFunnelCompanyWillCity.class;
	}
