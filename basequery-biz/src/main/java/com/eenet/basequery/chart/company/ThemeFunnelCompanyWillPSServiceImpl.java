...
public class ThemeFunnelCompanyWillPSServiceImpl extends SimpleBizImpl implements ThemeFunnelCompanyWillPSService {
	...
	@Override
	public Class<ThemeFunnelCompanyWillPS> getPojoCLS() {
		return ThemeFunnelCompanyWillPS.class;
	}
